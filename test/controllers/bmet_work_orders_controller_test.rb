...
class BmetWorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create bmet_work_order" do
    assert_difference('BmetWorkOrder.count') do
      post :create, bmet_work_order: { action_taken: @bmet_work_order.action_taken, bmet_item_id: @bmet_work_order.bmet_item_id, cause_description: @bmet_work_order.cause_description, cost: @bmet_work_order.cost, date_completed: @bmet_work_order.date_completed, date_expire: @bmet_work_order.date_expire, date_requested: @bmet_work_order.date_requested, description: @bmet_work_order.description, owner_id: @bmet_work_order.owner_id, prevention_taken: @bmet_work_order.prevention_taken, request_type: @bmet_work_order.request_type, requester_id: @bmet_work_order.requester_id, status: @bmet_work_order.status }
    end
