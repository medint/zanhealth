  ...
  def initialize(user)
    ...
    # https://github.com/ryanb/cancan/wiki/Defining-Abilities
      if user.role.name == "bmet_tech"
          ...
          can [:read, :create, :update], [BmetWorkOrder,BmetWorkRequest,BmetItem,BmetModel]
          ...
          cannot [:delete,:hide], [BmetItem, BmetWorkOrder,BmetWorkRequest,BmetPreventativeMaintenance, BmetModel] 
	  elsif user.role.name == "fac_tech"
	  	  can :manage, [FacilityCost, FacilityLaborHour, FacilityWorkOrderComment, FacilityDashboard]
	  	  can [:read, :create, :update], [FacilityWorkOrder, FacilityWorkRequest]
	  	  ...
	  	  cannot [:destroy, :hide], [FacilityWorkOrder,FacilityWorkRequest,FacilityPreventativeMaintenance]
	  elsif user.role.name == "bmet_fac_tech"
	  	  can :manage, [FacilityCost, FacilityLaborHour, FacilityWorkOrderComment, BmetCost, BmetLaborHour, BmetWorkOrderComment,FacilityDashboard]
	  	  can [:read, :create, :update], [BmetWorkOrder, FacilityWorkOrder,BmetWorkRequest, FacilityWorkRequest,BmetItem,BmetModel]
	  	  ...
	  	  cannot [:destroy, :hide], [BmetWorkOrder, FacilityWorkOrder, BmetWorkRequest, FacilityWorkRequest, BmetPreventativeMaintenance, FacilityPreventativeMaintenance,BmetItem, BmetModel]
	  end
  end
end
